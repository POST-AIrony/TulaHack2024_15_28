  ...
  return (
    <>
      <main className="w-full h-auto">
        <div className=" w-full h-[1080px] bg-[url('/static/purple.svg')] bg-cover block-image">
          ...
          {islogin ? (
            <div className="bubble anim">
              ...
              <input
                ...
                className="font-['Montserrat_Alternates'] font-extrabold input outline-none"
              />
              <br />
              <input
                type="password"
              ...
              <button
                ...
                className="font-['Montserrat_Alternates'] font-extrabold otvet outline-none"
              >
                Зарегистрируйтесь!
              </button>
            </div>
            ...
            <div className="bubble2 anim">
              ...
              <input
                type="text"
                placeholder="Имя пользователя"
                className="font-['Montserrat_Alternates'] font-extrabold input"
              />
              <br />
              <input
                type="password"
