...
export default function Home() {
  ...
  return (
    ...
    <div className="w-full h-[1080px]">
      ...
      Привет, пользователь! Это <h1 className="bg-gradient-to-r from-[#9002ff] to-[#ffdb5e] inline-block text-transparent bg-clip-text text-[50px] font-['Montserrat_Alternates'] font-extrabold p-center-two">
            EpicLab
          </h1>
          </h1>
