    ...
    <>
      ...
      <main className="w-full h-auto">
        <div className="pt-[350px] pl-[130px] w-full h-[1080px] bg-[url('/static/MainBackgroundImage.svg')]">
          <h1 className="bg-gradient-to-r from-[#9002ff] to-[#ffdb5e] inline-block text-transparent bg-clip-text text-[8rem] font-['Montserrat_Alternates'] font-extrabold">
            EpicLab
          </h1>
        ...
        <section className="relative py-[80px] px-[105px] w-full h-[910px] bg-[#151515] rounded-t-[150px]">
          ...
          <div className="flex justify-between items-center mt-[50px] w-full h-[380px]">
            {teamList.map((teamMember) => (
              ...
              >
                ...
                <p className="mt-[30px] text-[#ffffff] text-[1.75rem] text-center font-['Montserrat'] font-medium">
                  {teamMember.name} {teamMember.specialization}
                </p>

                <p className="text-[#ffffff] text-[1.75rem] text-center font-['Montserrat'] font-medium">
                  {teamMember.tgTag}
                </p>
              </div>
            ))}
          ...
          <p className="absolute bottom-[80px] right-[105px] w-[740px] text-[#8a8a8a] text-[1.5rem] text-right font-['Montserrat'] font-medium">
            Приложение сделано специально для CODEMASTERS INTERNATIONAL на
            хакатоне TulaHack 2024
          </p>
        </section>
      </main>
    </>
